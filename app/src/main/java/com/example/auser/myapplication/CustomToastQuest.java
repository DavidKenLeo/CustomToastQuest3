package com.example.android.customtoastquest;
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event)
        {
            ...
            if(event.getAction()==KeyEvent.ACTION_DOWN & keyCode == KeyEvent.KEYCODE_ENTER){
                ...
                if(((EditText)v)==et3){
                    ...
                    switch(choice){
                        case 1:Toast.makeText(CustomToastQuest.this, R.string.choice1, Toast.LENGTH_SHORT).show(); break;
                        case 2:Toast.makeText(CustomToastQuest.this, R.string.choice2, Toast.LENGTH_SHORT).show(); break;
                        case 3:Toast.makeText(CustomToastQuest.this, R.string.choice3, Toast.LENGTH_SHORT).show(); break;
                        case 4:Toast.makeText(CustomToastQuest.this, R.string.choice4, Toast.LENGTH_SHORT).show(); break;
                        default:Toast.makeText(CustomToastQuest.this, R.string.choice5, Toast.LENGTH_SHORT).show();
                    }
                }
                else
